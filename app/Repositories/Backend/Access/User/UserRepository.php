...
class UserRepository extends BaseRepository
{
    ...
    public function getForDataTable($status = 1, $trashed = false)
    {
        ...
        $dataTableQuery = $this->query()
            ...
            ->select([
                ...
                config('access.users_table') . '.gender',
    ...
    public function create($input)
    {
        ...
        $user = $this->createUserStub($data, $file);
    ...
    public function update(Model $user, array $input)
    {
        ...
        if (!empty($file)) {
            ...
            if ($ext == 'jpg' || $ext == 'png' || $ext == 'jpeg') {
                ...
                $picPath = '/uploads/userimages/' . $newFilename;
                $user->avatar = $picPath;
     ...
     * @return mixed
     */
    protected function createUserStub($input, $userImage)
    {
        $user = self::MODEL;
        $user = new $user;
