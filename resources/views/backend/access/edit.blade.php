    ...
    <div class="box box-success">
        ...
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    {{ Form::text('username', null, ['class' => 'form-control', 'maxlength' => '191', 'required' => 'required', 'placeholder' => 'USERNAME','disabled'=>'true']) }}
                </div><!--col-lg-10-->
            </div><!--form control-->
            <div class="form-group">
            ...
            @if ($user->id != 1)
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-1">
                        {{ Form::checkbox('confirmed', '1', $user->confirmed == 1,['class'=>'confirm']) }}
                    </div><!--col-lg-1-->
                </div><!--form control-->
                    ...
                    <div class="col-lg-3">
                        @if (count($roles) > 0)
                            @foreach($roles as $role)
                                <input class="theRoles" type="checkbox" value="{{$role->id}}" name="assignees_roles[{{ $role->id }}]"
