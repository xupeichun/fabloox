        ...
        <div class="box-body">
            ...
            <form class="form-inline">
                <div class="row" style="margin-bottom: 5px">
                    ...
                    <div class="form-group col-md-4">
                        <label>Show <select name="users-table_length" id="max" aria-controls="users-table"
                ...
                {{--                <div class="row">
                                    ...
                                    <input type="button" class="btn btn-default search_button" value="Search"/>
                                </div>--}}
            </form>
...
@section('after-scripts')
    ...
    @include('backend.access.product.includes.partials.fabloox-products')
@endsection
