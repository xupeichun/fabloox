...
<script>
    $(document).ready(function () {
        ...
        function search() {
            ...
            $.get("{{route('admin.ajax.get.products')}}", query)
                .done(function (data) {
                    $('#the_loader').hide();
                    console.log(data);
                    $('.table_body').empty();
            ...
            if (typeof(imgpath) != 'undefined' && typeof(id) != 'undefined' && imgpath != "" && id != "") {
                ...
                $.post("{{route('admin.access.product.add.gallery.products')}}", product_data).done(function (data) {
                    if (data.status == 200) {
                        ...
                        swal({
                            text: 'Product link added to gallery image!',
                            title: "Success!",
                            type: 'success'
