...
@section('page-header')
    <h1>
        ...
        <small>Edit Influencer videos</small>
    </h1>
@endsection
...
@section('content')
    ...
    {{ Form::open(['route' => ['admin.access.influencer.update.links'],  'class' => 'form-group form-horizontal', 'role' => 'form', 'method' => 'POST']) }}
        ...
        $(document).ready(function () {
            $(document).delegate('.link_delete_btn',"click", function () {
                ...
                swal({
                    ...
                    $.ajax({
                        url: "{{ route("admin.access.influencer.delete.links") }}",
                        data: {
                            'id': id,
                        },
                        type: 'POST',
