...
@section('content')
    {{ Form::open(['route' => 'admin.access.influencer.store', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post','enctype'=>"multipart/form-data"]) }}
    ...
    <div class="box box-success">
        ...
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    {{ Form::number('order', null, ['class' => 'form-control', 'maxlength' => '191', 'required' => 'required', 'autofocus' => 'autofocus', 'placeholder' => 'Order No.']) }}
                </div><!--col-lg-10-->
            </div>
