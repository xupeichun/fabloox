...
@section('content')
    <div class="box box-success">
        <div class="box-header with-border">
            <h3 class="box-title">Deactivated Images</h3>
                ...
                <table id="users-table" class="table table-condensed table-hover">
                    <thead>
                        <tr>
                            ...
                            <th>Image</th>
                            <th>Start Date</th>
                            <th>End Date</th>                            <th>{{ trans('labels.general.actions') }}</th>
                        </tr>
                    </thead>
                </table>
    ...
    <script>
        $(function() {
            $('#users-table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '{{ route("admin.access.gallery.all.deactivate") }}',
                    type: 'post',
    ...
    <script>
        $(document).delegate(".activateButton", "click", function () {
            ...
            swal({
                ...
                $.ajax({
                    url: "{{ route("admin.access.gallery.activateItem") }}",
                    data: {id: id},
                    type: 'get',
