...
@section('content')
    ...
    {{ Form::open(['route' => ['admin.access.brand.update.links'],  'class' => 'form-group form-horizontal', 'role' => 'form', 'method' => 'POST']) }}
                    ...
                    <div class="form-group link_row">
                        ...
                        <div class="col-lg-8">
                            <input class="form-control" required="required"
                                   ...
                                   type="url" value="@if(isset($data->videoLink)){{$data->videoLink}}@endif">
                        </div>
        ...
        $(document).ready(function () {
            $(document).delegate('.link_delete_btn',"click", function () {
                ...
                swal({
                    ...
                    $.ajax({
                        url: "{{ route("admin.access.brand.delete.links") }}",
                        data: {
                            'id': id,
                        },
                        type: 'POST',
