...
@endif -->
            ...
            <!--   <li class="dropdown tasks-menu">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        @if(@getimagesize(access()->user()->avatar) !== false )
                            <img src="{{ access()->user()->avatar }}" class="user-image" alt="User Avatar"/>
                        @else
                    ...
                    {{--<ul class="dropdown-menu">--}}
                        {{--<li class="user-header">--}}
                            {{--@if(getimagesize(access()->user()->avatar) !== false )--}}
                                {{--<img src="{{ access()->user()->avatar }}" class="img-circle" alt="User Avatar"/>--}}
                            {{--@else--}}
