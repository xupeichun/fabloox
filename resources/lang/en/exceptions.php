...
return [ 
		...
		'backend' => [ 
				...
				'theme' => [ 
						'create_error' => 'There was a problem creating this theme. Please try again.',
						'update_error' => 'There was a problem updating this theme. Please try again.',
						'delete_error' => 'There was a problem deleting this theme. Please try again.',
						'versions' => [ 
								'create_error' => 'There was a problem creating this theme version. Please try again.',
								'update_error' => 'There was a problem updating this theme version. Please try again.',
								'delete_error' => 'There was a problem deleting this theme version. Please try again.' 
						] 
				],
				'wordpress' => [ 
						'create_error' => 'There was a problem creating this wordpress version. Please try again.',
						'update_error' => 'There was a problem updating this wordpress version. Please try again.',
						'delete_error' => 'There was a problem deleting this wordpress version. Please try again.' 
				],
				'client' => [ 
            ...
            'network' => [
                'general_exception' => 'There is something wrong on the server',
                'whmcs_login_failure' => 'Whmcs login failed'
            ]
		],
